        ...
        <Fade duration={1500} delay={1500} distance="0px">
          <div className={styles.introductionWrapper}>
            <p className={`${styles.introduction}`}>
              After <span>a year and a half of coding </span>, I have already gone through each step
              of building an app (from design to testing) with <span> React </span>
              and an API written in <span> Python</span>. I’ve also been developing several websites
              to help others spread their
